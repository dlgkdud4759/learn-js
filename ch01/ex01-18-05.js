...
// } else if (
//   systemManagement > softwareDevelopment &&
//   systemManagement > databaseSetup &&
//   systemManagement > programmingUsage &&
//   systemManagement > softwareDesign
// ) {
...
if (avg >= 60 && minScore >= 40) {
  ...
  if (minScore < 40) {
    console.log(`아쉽지만 불합격입니다. 사유: 평균 40점 미달(${minScore}점)`);
  }
}
