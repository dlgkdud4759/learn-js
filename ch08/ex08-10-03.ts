...
(() => {
  ...
  function test() {
    ...
    f1()
      .then((result) => {
        console.log("8. 첫 번째 f1 완료", result.toLocaleUpperCase());
      })
      .then(f1)
      .then((result) => {
        console.log("9. 두 번째 f1 완료", result.toLocaleUpperCase());
      })
      .then(f1)
      .then((result) => {
        console.log("10. 세 번째 f1 완료", result.toLocaleUpperCase());
      })
      .then(f1)
      .then((result) => {
        console.log("11. 네 번째 f1 완료", result.toLocaleUpperCase());
      })
      .then(f1)
      .then((result) => {
        console.log("12. 다섯 번째 f1 완료", result.toLocaleUpperCase());
      })
      .then(f1)
      .then((result) => {
        console.log("13. 여섯 번째 f1 완료", result.toLocaleUpperCase());
        console.log(
          "🍀🍀🍀 당신은 행운아 🍀🍀🍀 로또 사세요.",
