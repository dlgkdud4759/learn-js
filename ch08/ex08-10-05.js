...
(() => {
    ...
    function test() {
        ...
        // 모든 작업이 성공하면 결과 배열 반환, 하나라도 실패하면 첫 번째 실패한 이유 반환
        // Promise.all([f1(), f1(), f1(), f1(), f1(), f1()])
        //   .then((result) => {
        //     console.log(result);
        //     console.log(
        //       "🍀🍀🍀 당신은 행운아 🍀🍀🍀 로또 사세요.",
        ...
        //     console.error(reason);
        //   });
        // 가장 먼저 settled된 결과 반환(성공, 실패 상관없음)
        // Promise.race([f1(), f1(), f1(), f1(), f1(), f1()])
        //   .then((result) => {
        //     console.log(result);
        //   })
        //   .catch((reason) => {
